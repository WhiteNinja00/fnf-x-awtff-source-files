...
class PlayState extends MusicBeatState
{
	...
	override public function update(elapsed:Float)
	{
		...
		{
			if (iconP1.animation.curAnim.name == 'white-ninja')
				iconP1.animation.play(SONG.player1);
			else
				iconP1.animation.play('white-ninja');
		}

		if (FlxG.keys.justPressed.TWO)
		{
			if (iconP1.animation.curAnim.name == 'joseph-animations')
				iconP1.animation.play(SONG.player1);
			else
				iconP1.animation.play('joseph-animations');
		}

		if (FlxG.keys.justPressed.THREE)
		{
			if (iconP1.animation.curAnim.name == 'coded-vr')
				iconP1.animation.play(SONG.player1);
			else
				iconP1.animation.play('coded-vr');
		}

		if (FlxG.keys.justPressed.FOUR)
		{
			if (iconP1.animation.curAnim.name == 'troll')
				iconP1.animation.play(SONG.player1);
			else
				iconP1.animation.play('troll');
		}

		if (FlxG.keys.justPressed.FIVE)
		{
			if (iconP1.animation.curAnim.name == 'pingu')
				iconP1.animation.play(SONG.player1);
			else
				iconP1.animation.play('pingu');
		}

		if (FlxG.keys.justPressed.SIX)
		{
			if (iconP1.animation.curAnim.name == 'amogus')
				iconP1.animation.play(SONG.player1);
			else
				iconP1.animation.play('amogus');
		}

		if (FlxG.keys.justPressed.EIGHT)
		{
			if (iconP1.animation.curAnim.name == 'bob')
				iconP1.animation.play(SONG.player1);
			else
				iconP1.animation.play('bob');
		}

		if (FlxG.keys.justPressed.NINE)
		{
			if (iconP1.animation.curAnim.name == 'troll-white-ninja')
				iconP1.animation.play(SONG.player1);
			else
				iconP1.animation.play('troll-white-ninja');
		}
